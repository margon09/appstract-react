...
To run this Project you will need to have Node.js v14.17.5 or later installed
https://nodejs.org/en/
...
npm test
Launches the Cypress test runner in the interactive watch mode for Integration tests.
